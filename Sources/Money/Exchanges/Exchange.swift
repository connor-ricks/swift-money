...
extension Exchange {
    ...
    @inlinable public func trade<C: Currency>(_ money: Money, for currency: C) throws -> Money {
    ...
    public func trade<C: Currency>(_ aggregatedMoney: AggregatedMoney, for currency: C) throws -> Money {
