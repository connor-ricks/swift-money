...
/// Currency is a medium of exchange for goods and services, typically issued by a government and circulated within an economy.
/// It serves as a unit of account, a store of value, and a medium of exchange.
///
/// A `Currency` requires providing an identifier used to uniquely identiy it among other currencies.
