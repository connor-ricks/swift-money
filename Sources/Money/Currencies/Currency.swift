...
///
/// A ``Currency`` requires providing an identifying ``Currency/id`` used to uniquely identiy it among other
/// currencies, as well as a ``Currency/minorUnits`` value representing the number of minor units the currency
/// supports. (i.e USD supports 2 minor units)
public protocol Currency: Identifiable, Hashable, Sendable {
